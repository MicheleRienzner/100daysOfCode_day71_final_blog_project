...
# in the page look for >> Send email in Python using Gmail API
# it can also be useful: https://mailtrap.io/blog/python-validate-email/

# original Angela's text and code:
